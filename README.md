...
$ git clone https://github.com/agency3/tgc-shop.git
$ cd tgc-shop
$ npm install
```
At this point, the theme should be installed and fully running on your local machine. If you prefer to install the theme manually, that will work as well - just be sure to run `npm install` after manually moving the files into the `/themes/` directory.
